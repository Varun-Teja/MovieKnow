...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("io.egen.spring_rest.entity");
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/employee_db?useSSL=false");
		ds.setUsername("root");
		ds.setPassword("varun123");
		return ds;
	}
